    ...
    return (
        <div className='overflow-hidden'>
            <section className={styles.backgroundImage}>
                <Navbar/>
                <h1 className='text-white font-[family-name:var(--font-lexend-giga-black)] text-left text-3xl px-2 md:text-left md:text-6xl lg:text-left lg:text-8xl lg:px-10 lg:mt-6 '>OBTENHA <br /> ENGENHARIA <br /> DE SOFTWARE <br /> ESPECIALIZADA </h1>
