...
function Intro() {
  return (
    <div className="h-all">
      <Navbar />
        <div className='mt-20 flex flex-col gap-2 md:flex-row md:justify-items-center md:items-center md:space-x-10'>
          <div className='mx-4 animate-pulse'>
            ...
            <h3 className='text-white font-kanit italic text-xl font-medium mt-8'>Nós nos integramos á sua equipe, 
